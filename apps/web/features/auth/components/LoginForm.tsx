    ...
    return (
        <div className="w-full">
            <header className="mb-10">
                <h2 className="text-2xl font-black tracking-tight text-slate-900 uppercase mb-2">Login</h2>
            </header>

            <form onSubmit={onSubmit} className="space-y-6">
                {/* Email Field */}
                <div className="space-y-1.5">
                    <label className="text-[11px] font-bold uppercase tracking-wider text-slate-500" htmlFor="email">
                        Email address
                    </label>
                    <input
                        type="email"
                ...
                <button
                    type="submit"
                    disabled={isPending}
                    className={`w-full bg-gradient-to-br from-blue-600 to-blue-800 text-white py-4 font-bold text-sm uppercase tracking-widest active:scale-[0.99] transition-all ${isPending ? "opacity-70 cursor-not-allowed" : "hover:shadow-lg hover:shadow-blue-100"
                        }`}
                >
